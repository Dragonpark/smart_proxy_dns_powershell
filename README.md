...
To enable this DNS provider, edit `/etc/foreman-proxy/settings.d/dns.yml` and set:
    ...
    :use_provider: dns_powershell

Configuration options for this plugin are in `/etc/foreman-proxy/settings.d/dns_powershell.yml` and include:
