require 'test_helper'
require 'smart_proxy_dns_powershell/dns_powershell_main'


class DnsPowershellRecordTest < Test::Unit::TestCase
  def setup
    @provider = Proxy::Dns::Powershell::Record.new('required_value', 'a_value', '/required/path', '/some/path', 999)
  end
